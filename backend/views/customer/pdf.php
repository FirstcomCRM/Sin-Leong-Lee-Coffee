                                ...
                                <table border>
                                    ...
                                    <tr>
                                        ...
                                        <td>";if($total_profit > 0 ){
                                            $output .=  "$".number_format($total_profit,2);
                                        }else{ 
                                            $output .=  "$0";
                                        }
                    $output .= "</td>
                    ...
                    $output .= "</td>
                            ...
                            <div style='margin-top: 10px;'>
                             ...
                             $output .= "<tr>
                                            ...
                                            <td>$".number_format($value['average_cost'],2)."</td>";
                                            $profits = $value['amount']-$value['average_cost']; 
                            $output .= " <td>";
                                                   if($profits > 0 ){ 
                                                            $output .= "$".number_format($profits,2); 
                                                        }else{ 
                                                            $output .=  "$0";
                                                        }
                            ...
                            $output .= "</td>
                                            ...
                                            <td>";
                                                    if(($profits/$value['amount'])*100 > 0){
                                                                $output .= number_format(($profits/$value['amount'])*100,2)."%";
                                                            }else{
                                                                $output .=  "$0";
                                                            }  
                                $output .= "</td>
                              ...
                              $output .= "<tr>
                                            ...
                                            <td style='border-top: 1px solid; border-collapse:separate; border-spacing:5px 5px;'><strong>$".number_format($grand_avg,2)."</strong></td>
                                        
                                            <td style='border-top: 1px solid; border-collapse:separate; border-spacing:5px 5px;'><strong>";
                                            if($grand_profits > 0){ 
                                                $output .=  "$".number_format($grand_profits,2); 
                                            }else{ 
                                                $output .=  "$0"; 
                                            }
                               $output .= " </strong></td>
                                            ...
                                            if((($grand_profits/$grand_expenses)*100)*100 > 0){ 
                                                $output .=  number_format(($grand_profits/$grand_total_amount)*100,2)."%"; 
                                            }else{ 
                                                $output .=  "$0"; 
                                            }
                               $output .= " </strong></td>
