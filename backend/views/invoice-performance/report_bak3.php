...
<tr>
  <td class="td-left" > <span class="sub-name"></span>4-110 Sales Coffee</td>
  <td>
...
<tr>
  <td class="td-left"><span class="sub-name">4-1130 Sales Mug</td>
  <td>
...
<?php
    ...
    $test = $query->andFilterwhere(['between', 'date', $date_from,$date_to])
          ->andFilterWhere(['customer_name'=>$searchModel->customer_name])
          ->andFilterWhere(['item_list.exp_cos'=>'5-1140'])
      //   ->sum('amount');
       ->all();
    //$test = $query->all();
  //  echo $test;
